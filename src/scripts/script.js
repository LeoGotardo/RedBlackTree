...
export default {toggleAnimation, solveDFS, solveBFS, solveBoth, reset, generateMaze, setCustomStart, setCustomEnd, setRandomEnd, updateSizeDisplay, applyNewSize, maze};